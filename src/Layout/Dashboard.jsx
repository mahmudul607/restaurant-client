...
import { FaBook, FaCalendar, FaUser, FaCartPlus, FaHome, FaList, FaMoneyCheckAlt, FaShoppingBag, FaUsers, FaUtensils } from "react-icons/fa";
...
const Dashboard = () => {
    ...
    return (
        <>
            <div className="max-sm:w-full max-sm:block hidden max-sm:h-18 max-sm:bg-white font-logoFont text-red-500">
                <h1 className="sm:text-2xl text-md font-extrabold px-4 mx-auto">Foods <br /><span className=" pl-8 text-black">Corner</span></h1>
            </div>
            <div className="flex ">

                <div className="w-12 lg:w-64 md:w-48 sm:w-44  bg-gray-400 fixed h-full flex flex-col ">
                    <div className="max-sm:hidden block max-sm:bg-white font-logoFont text-red-500">
                    ...
                    <ul className="menu py-2 px-0 sm:p-4 text-md text-gray-800 ">
                            ...
                            isAdmin ?
                                ...
                                <>  <li className="flex  gap-4">
                                    ...
                                    <NavLink to={'/dashboard/user'}>
                                        <FaUser className="sm:text-sm text-xl " title="Profile"></FaUser>
                                    ...
                                    <li className="flex  gap-4">
                                        ...
                                        <NavLink to={'/dashboard/cart'}>
                                            <FaCartPlus className="sm:text-sm text-xl sm:w-full" title="My Cart"></FaCartPlus>
                        ...
                        <div className="divider w-full bg-black h-[0.2rem]"></div>
                        <li className="flex  gap-4">
