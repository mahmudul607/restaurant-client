...
const UpdateMenuItem = () => {
    ...
    const onSubmit = async (data) => {
       ...
       if(typeof imageFile.image !== 'undefined'){
    ...
    <div className="bg-gray-200 p-8 mt-8">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <label className="form-control w-full ">
                ...
                <input {...register("name", {required:true})} defaultValue={item.name} type="text" placeholder="Type here" className="input input-bordered w-full " />
            </label>
            ...
            <label className="form-control w-full ">
                ...
                <select {...register("category",{required:true})} defaultValue={item.category} className="select select-bordered w-full p-3">
            ...
            <label className="form-control w-full ">
                ...
                <textarea {...register("details", {require:true})} defaultValue={item.recipe} className="textarea textarea-bordered h-24" placeholder="Bio"></textarea>
            </label>
